    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/sql" prefix="sql" %>
      <%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
        ...
        <sql:setDataSource driver="oracle.jdbc.driver.OracleDriver" url="jdbc:oracle:thin:@localhost:1521/xepdb1"
          user="csdc24vz_05" password="Eg3Noht" />
        ...
        <body>
          ...
          <div class="main-content">
            ...
            <form style="padding: 2;" id="flightSelection" method="post" action="Flug-Such-Erg.jsp">
              <div class="form-group">
                <label for="planet">Bitte geben sie ihren Abflugplaneten an</label>
                <select class="form-control" id="planet" name="SrcPlanet" size="1">
                  <sql:query var="fluegeSrc" sql="select distinct Abflugplanet from flug order by Abflugplanet" />
